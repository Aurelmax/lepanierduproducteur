      ...
      <div className='bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto'>
        ...
        <div className='sticky top-0 bg-white border-b px-6 py-4'>
          <div className='flex items-center justify-between'>
            <h2 className='text-2xl font-display font-bold text-accent-dark'>
        ...
        <div className='p-6'>
          ...
          <div className='space-y-6'>
            <h3 className='text-xl font-semibold text-accent-dark'>Vos informations</h3>
            ...
            {/* Méthode de livraison */}
            <div>
              <h4 className='text-lg font-semibold text-accent-dark mb-4'>Méthode de livraison</h4>
          ...
          <div className='mt-8 pt-6 border-t'>
            <h3 className='text-xl font-semibold text-accent-dark mb-4'>Paiement</h3>

            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              <button
                onClick={() => handlePayment('paypal')}
                disabled={isProcessing}
                className='flex items-center justify-center space-x-3 bg-blue-600 hover:bg-blue-700 text-white py-4 px-6 rounded-lg font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed'
              >
                {isProcessing ? (
              ...
              <button
                ...
                disabled={isProcessing}
                className='flex items-center justify-center space-x-3 bg-purple-600 hover:bg-purple-700 text-white py-4 px-6 rounded-lg font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed'
              >
                {isProcessing ? (
                  <div className='w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin'></div>
                ) : (
